...
## VIDT
_C.MODEL.TRANSFORMER.METHOD = "vidt"
_C.MODEL.TRANSFORMER.PRETRAINED = "imagenet"
_C.MODEL.TRANSFORMER.DET_TOKEN_NUM = 100
_C.MODEL.TRANSFORMER.REDUCED_DIM = 256
_C.MODEL.TRANSFORMER.CROSS_INDICES = [3]
_C.MODEL.TRANSFORMER.EPFF = False
_C.MODEL.TRANSFORMER.TOKEN_LABEL = False
_C.MODEL.TRANSFORMER.WITH_VECTOR = False
_C.MODEL.TRANSFORMER.WITH_BOX_REFINE = True
_C.MODEL.TRANSFORMER.PROCESSOR_DCT = None
_C.MODEL.TRANSFORMER.IOU_AWARE = False
_C.MODEL.TRANSFORMER.DISTIL = False
_C.MODEL.TRANSFORMER.MASKS = False
_C.MODEL.TRANSFORMER.DISTIL_MODEL = None
_C.MODEL.TRANSFORMER.VECTOR_START_STAGE = 0
##
...
## VIDT
_C.MODEL.TRANSFORMER.LOSS.VECTOR_LOSS_COEF = 3.0
_C.MODEL.TRANSFORMER.LOSS.NO_VECTOR_LOSS_NORM = False
##
